...
public class TarsUtil
{
    ...
    public static IdipServantPrx getIdipServantPrx(Integer environmentId)
    {
        ...
        {
            idipServantPrx=communicator.stringToProxy(IdipServantPrx.class,  "JSX.IdipSvr.IdipServantObj@tcp -h 192.168.18.113 -p 10078 ");
        ...
        /*else if(environmentId==222)
        {
            idipServantPrx=communicator.stringToProxy(IdipServantPrx.class,  "GFX.IdipSvr.IdipServantObj@tcp -h 192.168.18.112 -p 10060 ");
        } else if (environmentId==223)
        {
            idipServantPrx=communicator.stringToProxy(IdipServantPrx.class,  "GFX.IdipSvr.IdipServantObj@tcp -h 192.168.18.113 -p 10061 ");
        }*/
        else {
    ...
    {
        String str = "134156|0|7";
        List<TAccountID> tAccountIDS = fmtMail(str);
     ...
     * @return
     */
    public static List<TAccountID> fmtMail(String userList)
    {
        ...
        for (int i = 0; i < splitAddress.length/3; i++)
        {
            ...
            ta.setUuin(Integer.parseInt(splitAddress[3*i]));
            ta.setIosType(Integer.parseInt(splitAddress[3*i+1]));
            ta.setIzoneId(Integer.parseInt(splitAddress[3*i+2]));
